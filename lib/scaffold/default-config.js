...
/**
 * Will return the path and default berycore-node configuration. It will search for the
 * configuration file in the "~/.berycoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.berycoin');
  var defaultConfigFile = path.resolve(defaultPath, './berycore-node.json');
