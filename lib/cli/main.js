...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `berycore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ berycore-node add wallet-service');
      console.log('    $ berycore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ berycore-node remove wallet-service');
      console.log('    $ berycore-node remove insight-api');
      console.log();
    });
